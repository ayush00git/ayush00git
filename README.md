...
* [Advanced Go and System Design](https://github.com/ayush00git/laca-web/tree/dev/gin) - Working on the [cms-web](https://github.com/ayush00git/cms-web), it's core is written in go. Working on [goth](https://github.com/ayush00git/goth) as well, it's an gRPC based authentication microservice.
...
---
## Projects
* **peek-ai** - It's the most silent, light-weight resident of kernel. hacks your system, giving it AI's intelligence from the kernel level. Only shipped for Linux yet. No plans to make it open source yet.
